...
[Rc-Datetime-Picker]: https://github.com/AllenWooooo/rc-datetime-picker
...
<table class="table table-bordered table-striped">
  ...
  <tbody>
    <tr>
      <td>dayjs</td>
      <td>Object: {start: dayjs, end: dayjs}</td>
      <td></td>
      <td>Set the selected date range.</td>
    </tr>
    <tr>
      <td>onChange</td>
      <td>Function(datetime: {start: dayjs, end: dayjs})</td>
      <td></td>
    ...
    <tr>
      <td>shortcuts</td>
      <td>Object:{name: {start: dayjs, end: dayjs}}</td>
      <td></td>
