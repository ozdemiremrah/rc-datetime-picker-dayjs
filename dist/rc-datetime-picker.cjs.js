...
var Day = function (_Component) {
  ...
  function Day(props) {
    ...
    _this.changeMonth = function (dir) {
      ...
      _this.setState({
        dayjs: _dayjs[dir === 'prev' ? 'subtract' : 'add'](1, 'month')
      });
    };
    ...
    _this._renderDay = function (week, day) {
      ...
      var now = dayjs();
      var _dayjs = _this.state.dayjs;
      var isPrevMonth = week === 0 && day > 7;
      var isNextMonth = week >= 4 && day <= 14;
      var month = isNextMonth ? _dayjs.clone().add(1, 'month') : isPrevMonth ? _dayjs.clone().subtract(1, 'month') : _dayjs.clone();
  ...
  createClass(Day, [{
    ...
    value: function render() {
      ...
      var _dayjs = this.state.dayjs;
      var firstDay = _dayjs.clone().date(1).day();
      var endOfThisMonth = _dayjs.clone().endOf('month').date();
      var endOfLastMonth = _dayjs.clone().subtract(1, 'month').endOf('month').date();
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'span',
            { className: 'current-date', onClick: changePanel.bind(this, 'month', _dayjs) },
            _dayjs.format(dayFormat)
          ),
          React__default.createElement(
            'button',
...
var Month = function (_Component) {
  ...
  function Month(props) {
    ...
    _this.changeYear = function (dir) {
      ...
      _this.setState({
        dayjs: _dayjs[dir === 'prev' ? 'subtract' : 'add'](1, 'year')
      });
    };
    ...
    _this._renderMonth = function (row, month, idx) {
      ...
      var currentMonth = _dayjs.clone().month(month);
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'span',
            { className: 'current-date', onClick: changePanel.bind(this, 'year', _dayjs) },
            _dayjs.format('YYYY')
          ),
          React__default.createElement(
            'button',
...
var Year = function (_Component) {
  ...
  function Year(props) {
    ...
    _this.changePeriod = function (dir) {
      ...
      _this.setState({
        dayjs: _dayjs[dir === 'prev' ? 'subtract' : 'add'](10, 'year')
      });
    };
    ...
    _this.select = function (year, isDisabled) {
      ...
      _this.props.onSelect(_dayjs);
    };

    _this._renderYear = function (year) {
      var now = dayjs();
      var _dayjs = _this.state.dayjs;
      var firstYear = Math.floor(_dayjs.year() / 10) * 10;
      var _this$props = _this.props,
          maxDate = _this$props.maxDate,
          minDate = _this$props.minDate,
          selected = _this$props.selected,
      ...
      var currentYear = _dayjs.clone().year(year);
...
var Calendar = function (_Component) {
  ...
  function Calendar(props) {
    ...
    _this.state = {
      dayjs: _this.getCurrentDayjs(props),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getCurrentDayjs = function (props) {
    var range = props.range,
        rangeAt = props.rangeAt;

    var now = _this2.state ? _this2.state.dayjs || dayjs$1() : dayjs$1();
    var result = props.dayjs;
  ...
  this.handleSelect = function (selected) {
    ...
    var _selected = _this2.props.dayjs;
  ...
  this.changePanel = function (panel) {
    var dayjs$$1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this2.state.dayjs;
...
var Range = function (_Component) {
  ...
  function Range(props) {
    ...
    _this.handleChange = function (dayjs$$1) {
      _this.setState({
        dayjs: dayjs$$1
      });
    };

    _this.handleShortcutChange = function (dayjs$$1, isCustom) {
      ...
      if (isCustom) {
        ...
        onChange && onChange(dayjs$$1);
      }
    };

    _this.onConfirm = function () {
      var dayjs$$1 = _this.state.dayjs;
      var onChange = _this.props.onChange;
  ...
  createClass(Range, [{
    ...
    value: function render() {
      ...
      var props = blacklist(this.props, 'className', 'isOpen', 'format', 'dayjs', 'showTimePicker', 'shortcuts', 'onChange');
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          'div',
          { className: 'tools-bar' },
          shortcuts ? React__default.createElement(Shortcuts, _extends({}, props, { dayjs: dayjs$$1 || {}, range: true, shortcuts: shortcuts, onChange: this.handleShortcutChange })) : undefined,
          React__default.createElement(
            'div',
            { className: 'buttons' },
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                React__default.createElement(
                  ...
                  React__default.createElement(
                    ...
                    dayjs$$1 && dayjs$$1.start ? dayjs$$1.start.format(formatStyle) : undefined
                  )
                ),
                React__default.createElement(
                  'td',
                  ...
                  React__default.createElement(
                    'span',
                    { className: 'text-value' },
                    dayjs$$1 && dayjs$$1.end ? dayjs$$1.end.format(formatStyle) : undefined
                  )
                )
              ),
              React__default.createElement(
...
var Trigger = function (_Component) {
  ...
  function Trigger() {
    ...
    _this.handleChange = function (dayjs$$1, currentPanel) {
      var _this$props = _this.props,
